...
const DOMAINS: DomainItem[] = [
  {
    ...
    subtitleEn: 'INTELLIGENT SYSTEMS & AUTOMATION',
    subtitleAr: 'الأنظمة الذكية والأتمتة',
    accent: '#E64A24',
    capabilitiesEn: [
      'LLM Applications',
      'Generative AI',
    ...
    capabilitiesAr: [
      'تطبيقات النماذج اللغوية الكبيرة (LLMs)',
  ...
  },
  {
    ...
    subtitleEn: 'CORE LANGUAGES & FRAMEWORKS',
    subtitleAr: 'لغات البرمجة وأطر العمل',
    accent: '#B82024',
    capabilitiesEn: [
      'Python',
      'JavaScript',
  ...
  },
  {
    id: 'data-business',
    number: '03',
    titleEn: 'DATA & BUSINESS',
    titleAr: 'البيانات وتحليل الأعمال',
    subtitleEn: 'ANALYTICS & DECISION SYSTEMS',
    subtitleAr: 'التحليلات وأنظمة اتخاذ القرار',
    accent: '#F27A32',
    capabilitiesEn: [
    ...
    capabilitiesAr: [
      'تحليل وتنظيف وتجهيز البيانات',
      'التحليل الاستكشافي للبيانات (EDA)',
      'تصور البيانات ولوحات القياس',
      'الأسس والمفاهيم الإحصائية',
      'تحليل الأعمال ومؤشرات الأداء (KPIs)',
      'اتخاذ القرارات المبنية على البيانات',
    ],
    quoteEn: "I don't only build systems. I understand the data behind them and the business decisions they support.",
    quoteAr: 'لا أكتفي ببناء الأنظمة البرمجية؛ بل أفهم البيانات الكامنة خلفها والقرارات الاستراتيجية التي تدعمها.',
  },
  {
    id: 'product',
    number: '04',
    titleEn: 'PRODUCT ENGINEERING',
    titleAr: 'هندسة المنتجات الرقمية',
    subtitleEn: 'CONCEPT TO PRODUCTION',
    subtitleAr: 'من الفكرة المجردة إلى الإنتاج الفعلي',
    accent: '#B9ADA1',
    capabilitiesEn: [
    ...
    capabilitiesAr: [
      ...
      'تطبيقات ومواقع الويب المتطورة',
      'تطبيقات الهاتف المحمول',
      'بناء وتطوير منتجات SaaS',
      'هندسة وبنية المنتجات الرقمية',
      'تطوير البرمجيات من البداية للنهاية',
    ],
  },
];
